import{a as p,o as l,e as t,f as o,p as r,F as u}from"./index-BRBEb_Dj.js";const i={},m=`<p>라우터는 URL과 컴포넌트를 연결해주는 역할을 합니다. 예를 들어 사용자가 로그인 URL로 접속하면 로그인 컴포넌트를 연결하고, 장바구니 URL로 접속하면 장바구니 컴포넌트를 연결해주는 것이죠. 마치 영화 감독이 상황에 따라 어떤 장면을 촬영할 건지 결정하는 것과 비슷합니다.</p>
...
\r
| 방식          | 설명                                    | 전환 시간   | 초기 로드 시간   |\r
|-|-|-|-|\r
| 정적 임포트 | 컴포넌트 미리 로드                 | 빠름       | 오래 걸림        |\r
